...
- Confirm the title is `Math Rocket (JJCC)` and the English subtitle is correct.
...
- Reset progress and confirm only Math Rocket (JJCC) progress keys are removed; audio preferences remain.
